...
namespace Broccoli.TreeNodeEditor
{
	...
	public class GirthTransformNodeEditor : BaseNodeEditor {
		...
		SerializedProperty propGirthAtBase;
		SerializedProperty propGirthAtTop;
		...
		protected override void OnEnableSpecific () {
			...
			propGirthAtBase = GetSerializedProperty ("girthAtBase");
			propGirthAtTop = GetSerializedProperty ("girthAtTop");
