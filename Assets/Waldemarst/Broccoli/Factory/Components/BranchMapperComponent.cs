			...
			if (GlobalSettings.experimentalMeshPerBranch) {
				if (branchMeshGeneratorElement != null) {
					...
					*/
					...
					treeMeshMetaBuilder.applyMappingOffsetFromParent = branchMapperElement.applyMappingOffsetFromParent;
					...
					treeMeshMetaBuilder.BeginUsage (tree, branchMeshGeneratorComponent.branchSkins);
					var branchEnumerator = branchMeshGeneratorComponent.branchMeshes.GetEnumerator ();
