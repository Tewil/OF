...
namespace Broccoli.Model {
    ...
    public class CurvePoint {
        ...
        public CurvePoint(Vector3 location, Vector3 tangent, Vector3 forward, Vector3 normal, Vector3 up, Vector2 scale, float girth, float roll, float distanceInCurve, float timeInCurve) {
            ...
            this.relativePosition = timeInCurve;
        }
