...
namespace Broccoli.Base
{
	public static class GlobalSettings
	{
		...
		/// <summary>
		/// Enables sharing probability of occurrence for levels on the structure generator element.
		/// </summary>
		public static bool experimentalSharedStructureLevelsEnabled = true;
		/// <summary>
		/// The experimental sprout lab enabled.
		/// </summary>
		public static bool experimentalSproutLabEnabled = false;
		/// <summary>
		/// The experimental flag for low poly tools.
		/// </summary>
		public static bool experimentalLowPolyToolsEnabled = false;
		/// <summary>
		/// The experimental flag to apply color to mesh vertices on the sprout mapper processing.
		/// </summary>
		public static bool experimentalSproutMeshColorVariationEnabled = true;
		/// <summary>
		...
		/// <summary>
		/// The experimental flag to enable roots at the structure generator element.
		/// </summary>
		public static bool experimentalRootsEnabled = true;
		/// <summary>
		/// The experimental flag to keep every branch as an individual mesh.
		/// </summary>
		public static bool experimentalMeshPerBranch = false;
		/// <summary>
